    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 transition-colors duration-300">
      ...
      >
        ...
        <div className="my-5 sm:my-6 flex items-center">
          ...
          <span className="mx-4 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
            or
          </span>
          <div className="flex-grow border-t border-gray-300 dark:border-gray-600"></div>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4">
          <button className="w-full py-2 sm:py-3 px-4 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 flex items-center justify-center transition-all duration-200 text-sm sm:text-base">
